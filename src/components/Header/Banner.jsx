...
const Banner = () => {
    return (
        <div className='mt-8 bg-purple-100 text-center rounded-lg py-10 md:py-16'>
            ...
            <button className="btn text-lg outline-double outline-purple-400 active:outline-offset-2 active:bg-purple-500 hover:bg-purple-400 hover:text-white mt-8">Loearn More!</button>
        </div>
    );
};
